...
public class ViewSinhVien extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tbHienThi.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"Nguyễn Thuý Hằng", "Loại 1", "Nữ", "Ăn và lăn"},
                {"Nguyễn Anh Dũng", "Loại 2", "Nam", "Ăn"},
                {"Vũ Văn Nguyên", "Loại 1", "Nam", "Ăn "},
                {"Nguyễn Hoàng Tiến", "Loại 4", "Nam", "Lăn"},
                {"Trần Tuấn Phong", "Loại 1", "Nam", "Lăn"}
            },
            new String [] {
